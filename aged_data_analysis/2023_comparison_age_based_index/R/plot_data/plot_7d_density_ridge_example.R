...
for(i in unique(spatial_df_hh_ca_5$ScientificName)){
  ...
  plot_dat <- Species_dat %>%  filter(EastWest %in% c("BTS 7D North Sea"))
  ...
  ggsave(paste("figures/Den_PLOT/Den_Plot_7d",i,".png",sep=""),width = 12, height = 12, dpi = 300)
  ...
  ggsave(paste("figures/Den_PLOT/Den_Plot_7d_ECD",i,".png",sep=""),width = 12, height = 12, dpi = 300)
